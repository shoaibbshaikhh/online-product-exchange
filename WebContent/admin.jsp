...
<body>
    ...
    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/olpx","root","");
    ...
    <table class="table"  border=1>
        ...
        // Establish database connection
        Class.forName("com.mysql.jdbc.Driver");
    Connection conn2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/olpx","root","");
    ...
    <table class="table" border=1>
        ...
        // Establish database connection
        Class.forName("com.mysql.jdbc.Driver");
    Connection conn3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/olpx","root","");
